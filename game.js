...
const BOSS_CONFIG = {
    ...
    boss1: { width: 250, height: 350, scale: 1,   speed: 2.5, downScale: 1,    downOffset: 0, offset: 0, mirrorFlip: true, throwCount: 6, throwTimeToTarget: 100, throwHitChance: 0.3, throwDamage: 3 },
...
const assets = {
    ...
    ...Object.fromEntries(Array.from({ length: 96 }, (_, i) => (2 * i + 1)).map((fileNum, i) => ['supC' + (i + 1), { src: encodeURI('assets/supC/clideo_editor_a34f2999050349deab53e2f225af9fa2-' + fileNum + ' (gesleept).png'), canvas: document.createElement('canvas'), loaded: false, label: 'Supporter C run ' + (i + 1) }])),
...
const SUP_C_KEYS = Array.from({ length: 96 }, (_, i) => 'supC' + (i + 1));
